...
public class UsuarioRepositoryTest {
	...
	void start() {
		...
		usuarioRepository.save(new Usuario(0L, "paula.campanholi@hotmail.com", "12345678", null, null, null, null, null));
		usuarioRepository.save(new Usuario(0L, "vinicius.campanholi@gmail.com", "13456789", null, null, null, null, null));
		usuarioRepository.save(new Usuario(0L, "sandra.campanholi@hotmail.com", "234567890", null, null, null, null, null));
		usuarioRepository.save(new Usuario(0L, "guilhereme.ariza@hotmail.com", "345678901", null, null, null, null, null));
	}
